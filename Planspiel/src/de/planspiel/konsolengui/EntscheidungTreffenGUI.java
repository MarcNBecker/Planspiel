			...
			while(true){
				try {
					...
					if(cmd.equals("HILFE")){
						...
						writer.println("HÄNDLER ----------------------------------------------- Zeigt eine Liste aller Händler an mit deren Angeboten");
						writer.println("FILIALE ----------------------------------------------- Zeigt eine Liste aller Filialen an");
						writer.println("LAGER ------------------------------------------------- Zeigt den Lagerbestand an");
						writer.println("FILIALE_ERÖFFNEN standortName,mitarbeiterAnzahl ------- Erzeugt eine Filiale am angegebenen Standort mit der entsprechend Mitarbeiteranzahl");
						...
						writer.println("MARKETING_DURCHFÜHREN standortName,betrag ------------- Führt Marketing für den angegebenen Betrag am Standort durch");
						...
						writer.println("MITARBEITER_ENTLASSEN standortName,mitarbeiterAnzahl -- Entlässt die Anzahl Mitarbeiter in der Filiale am Standort");
						writer.println("ROHSTOFF_EINKAUFEN händlerName,produktName,menge ------ Kauft das entsprechende Produkt in der entsprechenden Menge beim Händler ein");
