...
public class FilialeEroeffnenEntscheidung extends Entscheidung {
	 ...
	 * @param standort
	 *            Der Standort an dem die neue Filiale eröffnet werden soll
	 * @param mitarbeiter
	 *            Die Anzahl der Mitarbeiter, die in die Filiale eingestellt
	 *            werden sollen
	 */
	...
	/**
	 * Führt die Entscheidung aus Eröffnet eine neue Filiale und setzt die
	 * Mitarbeiteranzahl
	 */
