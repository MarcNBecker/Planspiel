...
public class MitarbeiterEntlassenEntscheidung extends Entscheidung {
	 ...
	 * @param kette Kette, die Mitarbeiter einstellt
	 * @param mitarbeiter Anzahl der zusätzlichen Mitarbeiter
	 */
	 ...
	 * @param filiale Filiale, die Mitarbeiter entlässt
	 * @param mitarbeiter Anzahl der Mitarbeiter, die entlassen werden sollen
	 */
	 ...
	 * Entlässt die Mitarbeiter und verbucht die Kosten dafür,
	 * ggf. werden lediglich Mitarbeiter von einer Abteilung in die andere umgeschichtet
	 */
	public void ausfuehren() {
		...
		if(filiale != null && mitarbeiter > 0) {
			...
			if (restE < 0) {
				...
				//Es sind noch Einstellungen vorhanden, die die Entlassungen ausgleichen können
