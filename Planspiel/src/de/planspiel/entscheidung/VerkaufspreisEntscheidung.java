...
/**
 * Abstraktion einer Entscheidung zur Änderung des Verkaufspreises eines Produkts
 * @author Marc
 */
public class VerkaufspreisEntscheidung extends Entscheidung {
	 ...
	 * @param produkttyp Produkt, für welches die Verkaufspreise geändert werden sollen
	 * @param vkpreis neuer Verkauspreis
	 */
