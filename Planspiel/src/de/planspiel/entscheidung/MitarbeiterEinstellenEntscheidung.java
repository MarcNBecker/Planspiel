...
public class MitarbeiterEinstellenEntscheidung extends Entscheidung {
	 ...
	 * @param filiale Filiale, die die neuen Mitarbeiter entgegen nimmt
	 * @param mitarbeiter Anzahl der Mitarbeiter, die eingestellt werden sollen
	 */
