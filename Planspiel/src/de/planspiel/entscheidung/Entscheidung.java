...
/**
 * Abstrakte Klasse für eine Entscheidung
 * Die Funktion dieser ist sich darum zu kümmern, dass das Spiel alle Entscheidungen mitgeteilt bekommt
 * @author Marc
 *
 */
public abstract class Entscheidung {
	...
	/**
	 * Erzeugt eine neue Entscheidung und teilt dem Spiel mit, dass diese Entscheidung für
	 * eine bestimmte Kette erzeugt wurde
	...
	/**
	 * Diese Methode kann vom Spiel für jede Entscheidung aufgerufen werden,
	 * um den Effekt der Entscheidung durchzuführen
	 */
