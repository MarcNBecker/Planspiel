...
public class VerkaufsListe extends ProduktVerwalter {
	...
	/**
	 * Erzeugt eine neue VerkaufsListe, welche die Anzahl der verkauften Produkte angibt
	 * @param kette
	 */
	...
	/**
	 * Überträgt die Produkte des Lagers in die Verkaufsliste, übernimmt Qualität, EKPreis und Preis, setzt Menge aber auf 0
	 * @param lager Lager, dessen Produkte übertragen werden
	 */
	...
	/**
	 * Erhöht die gespeicherte Verkaufsmenge eines Produkts um die angegebene Menge
	 * @param name Produkttyp, um welches Produkt es sich handelt
	 * @param menge Menge, um die die Verkaufsmenge erhöht wird
	 */
