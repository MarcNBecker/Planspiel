...
public class Produkt {
	 ...
	 * 
	 * @param name
	 *            Enum-Wert, um welches Produkt es sich handelt
	 * @param qualitaet
	...
	/**
	 * Konstruktor für Produkte, die von der Entscheidung erzeugt werden und nur
	 * Name und Menge besitzen
	 * 
	 * @param name
	 *            Produkttyp-Wert, der angibt welches Produkt es ist
	 * @param menge
	 *            int-Wert, der die gewünschte Menge angibt
	 */
	...
	/**
	 * Vergleicht ein übergebenes Produkt mit sich selbst (meine Obergrenze
	 * Preis eingehalten?, meine Untergrenze Qualität eingehalten?)
	 * 
	 * @param produkt
	 *            Produkt, dessen Name, Qualitaet und Preis mit sich selbst
	 *            verglichen werden
	...
	public boolean vergleichen(Produkt produkt) {
		...
		// kleiner
		if (produkt != null && produkt.holeName().equals(this.holeName()) && produkt.holeQualitaet() >= this.holeQualitaet() && produkt.holePreis() <= this.holePreis())
			return true;
		else
			return false;
	}
	...
	/**
	 * Verschmilzt das bereits vorhandene Produkt mit dem Übergebenen, berechnet
	 * neue Durchschnittsqualitaet, Durchschnittsekpreis und Gesamtmenge und
	 * übernimmt Verkaufspreis vom aufrufenden Produkt
	 * 
	 * @param produkt
	...
	public Produkt verschmelzen(Produkt produkt) {
		if (!(produkt.holeName().equals(this.holeName())))
			return null;
				...
				// Berechne Gesamtmenge, neue durchschnittliche Qualität und
				// neuen durchschnittlichen EkPreis, übernimm Werte
	 ...
	 * 
	 * @param menge
	 *            Menge wird auf 0 gekappt, wenn sie kleiner als 0 ist.
	 */
